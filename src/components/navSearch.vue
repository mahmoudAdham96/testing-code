      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
        ...
        >
                ...
                <li aria-labelledby="dropdownNavbarLink">
                  ...
                  <div
                    ...
                    style="
                      ...
                      margin: 0px;
                      transform: translate3d(10.4px, 0px, 0px);
                    "
          ...
          <li>
            <a
              href="#"
              class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-yellow-600 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >Honey Gold</a
            >
          </li>
          <li>
